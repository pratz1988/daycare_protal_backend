...
Activity.create([
    {breakfast: 'pancakes,milk', morningActivity: 'circular discussion, reading books', lunch: 'mac & chhese', napStartTime: '1:00', napEndTime: '3:00', afternoonSnack: 'GoldFish', afternoonActivity: 'playing outside with sandbox', date: Date.parse("Dec 12 2019"), child_id: 1,teacher_id: 1},
    {breakfast: 'pancakes,milk', morningActivity: 'circular discussion, reading books', lunch: 'mac & chhese', napStartTime: '1:10', napEndTime: '2:55', afternoonSnack: 'GoldFish', afternoonActivity: 'playing outside with slides', date: Date.parse("Dec 12 2019"), child_id: 2,teacher_id: 1},
    {breakfast: 'pancakes,milk', morningActivity: 'circular discussion, reading books', lunch: 'mac & chhese', napStartTime: '1:20', napEndTime: '3:00', afternoonSnack: 'GoldFish', afternoonActivity: 'playing outside with trucks', date: Date.parse("Dec 12 2019"), child_id: 3,teacher_id: 1},
    {breakfast: 'pancakes,milk', morningActivity: 'circular discussion, reading books', lunch: 'mac & chhese', napStartTime: '1:00', napEndTime: '3:05', afternoonSnack: 'GoldFish', afternoonActivity: 'playing outside with bikes', date: Date.parse("Dec 12 2019"), child_id: 4,teacher_id: 1},
    {breakfast: 'pancakes,milk', morningActivity: 'circular discussion, reading books', lunch: 'mac & chhese', napStartTime: '1:10', napEndTime: '3:10', afternoonSnack: 'GoldFish', afternoonActivity: 'playing outside with slides', date: Date.parse("Dec 12 2019"), child_id: 5,teacher_id: 1},
    {breakfast: 'pancakes,milk', morningActivity: 'circular discussion, reading books', lunch: 'mac & chhese', napStartTime: '1:15', napEndTime: '2:45', afternoonSnack: 'GoldFish', afternoonActivity: 'playing outside with sandbox', date: Date.parse("Dec 12 2019"), child_id: 6,teacher_id: 1},
